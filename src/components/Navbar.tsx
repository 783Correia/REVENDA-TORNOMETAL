    ...
    >
      <div className="max-w-[1120px] h-full w-full mx-auto px-5 flex items-center justify-between">
        ...
        <a
          ...
          className="hidden lg:flex items-center gap-2 rounded-lg px-4 py-2 text-[13px] font-semibold text-white bg-[#25D366] transition-all duration-200 hover:bg-[#20BD5A]"
        >
      ...
      {menuOpen && (
        <div className="fixed top-[80px] right-4 w-[280px] z-[100] flex flex-col bg-[#0F172A]/95 backdrop-blur-xl border border-white/10 rounded-2xl p-2 shadow-2xl py-3 transform animate-in fade-in slide-in-from-top-4 lg:hidden">
          ...
          <a
            ...
            rel="noopener noreferrer"
            onClick={() => setMenuOpen(false)}
            className="flex items-center justify-center gap-2 mt-1 mx-2 rounded-xl px-5 py-3 font-semibold text-white bg-[#25D366] hover:bg-[#20BD5A] transition-colors"
          >
