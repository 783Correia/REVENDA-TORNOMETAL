      ...
      <div className="max-w-[1120px] mx-auto px-5">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="max-w-[640px]">
            ...
            <motion.p
              className="mt-5 text-[#475569] text-[15px] leading-[1.8]"
              variants={fadeUp}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, margin: "-80px" }}
            ...
            <motion.p
              className="mt-4 text-[#475569] text-[15px] leading-[1.8]"
              variants={fadeUp}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, margin: "-80px" }}
          ...
          <motion.div
            className="relative w-full aspect-[4/3] sm:aspect-video lg:aspect-[4/3] rounded-2xl overflow-hidden shadow-xl border border-[#E2E8F0]"
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, margin: "-80px" }}
          >
            ...
            <div className="absolute bottom-6 left-6">
              <div className="px-5 py-3 bg-white/95 backdrop-blur-md rounded-xl border border-[#E2E8F0] inline-block shadow-lg inline-flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  <p className="text-[#0F172A] font-semibold text-[13px] leading-tight">Sede Principal</p>
                  <p className="text-[#64748B] text-[11px] leading-tight">Passo Fundo, RS</p>
                </div>
              </div>
            </div>
          </motion.div>
